...
class CodeChef {
    ...
    /* docstring*/
    static void PROGLANG() throws IOException{
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            // Write Your Code...
            int features[] = sc.readArray(2);
            int lang1[] = sc.readArray(2);
            int lang2[] = sc.readArray(2);
            int isLang1 = 0;
            int isLang2 = 0;
            for(int i=0;i<lang1.length;i++){
                if(features[0] == lang1[i] || features[1] == lang1[i]){
                    isLang1++;
                }
            }
            for(int i=0;i<lang2.length;i++){
                if(features[0] == lang2[i] || features[1] == lang2[i]){
                    isLang2++;
                }
            }
            if(isLang1 == 2){
    ...
    /* docstring*/
    static void MXEVNSUB() throws IOException{
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            // Write Your Code...
            int N = sc.nextInt();
