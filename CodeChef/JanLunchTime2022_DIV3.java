...
class CodeChef {
    ...
    /* docstring */
    static void LOCKDRAW() throws IOException {
    ...
    /* docstring */
    static void SUBSTADD() throws IOException {
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            ...
            boolean flag = true;
            int arr_a[] = sc.readArray(n);
            int arr_b[] = sc.readArray(n);
            for (int i = 0; i < arr_b.length; i++) {
                if (arr_b[i] - arr_a[i] != x && arr_b[i] - arr_a[i] != y) {
                    flag = false;
                    break;
                }
            }
    ...
    /* docstring */
    static void SUBPERM() throws IOException {
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            int n = Integer.parseInt(sc.next());
    ...
    /* docstring */
    static void PREZ() throws IOException {
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            int n = Integer.parseInt(sc.next());
            int k = Integer.parseInt(sc.next());
