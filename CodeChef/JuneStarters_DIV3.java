...
class CodeChef {
    ...
    /* docstring*/
    static void CYCLICQD() throws IOException{
    ...
    /* docstring*/
    static void BLITZ3_2() throws IOException{
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            // Write Your Code...
            int arr[] = sc.readArray(3);
            System.out.println( ( 2*(180+arr[0]) ) - ( arr[1] + arr[2] ) );
        }
        fop.flush();
        fop.close();
    }
    ...
    /* docstring*/
    static void TOTCRT() throws IOException{
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            // Write Your Code...
            int n = sc.nextInt();
            ...
            for (int i = 0; i < n*3; i++) {
                ...
                if(hm.containsKey(ques)){
                    hm.put(ques,hm.get(ques)+solutions);
                }
                else{
                    hm.put(ques,solutions);
                }
            }
    ...
    /* docstring*/
    static void CHEFQUER() throws IOException{
        // int T = Integer.parseInt(sc.next());
        // while (T-- > 0) {
            // Write Your Code...
            int n = sc.nextInt();
    ...
    /* docstring*/
    static void SLPCYCLE() throws IOException{
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            // Write Your Code...
            long L = sc.nextLong();
