...
class CodeChef {
    ...
    /* docstring */
    static void CHEFBARBER() throws IOException {
    ...
    /* docstring */
    static void EUREKA() throws IOException {
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            int n = Integer.parseInt(sc.next());
            int ans = (int) Math.round( Templates.powerDouble( (0.143*n),n) );
    ...
    /* docstring */
    static void BINBASBASIC() throws IOException {
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            int n = Integer.parseInt(sc.next());
