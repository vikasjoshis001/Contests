...
class CodeChef {
    ...
    /* docstring */
    static void BADMINTON() throws IOException {
    ...
    /* docstring */
    static void AVOIDCONTACT() throws IOException {
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            // Write Your Code...
    ...
    /* docstring */
    static void EVMHACK() throws IOException {
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            ...
            int user_votes = a+b+c;
            int votes_to_win = total_votes/2 + 1;
            int votes_req = votes_to_win - user_votes;
            int arr1[] = {p, q, r};
            int arr2[] = {a, b, c};
            boolean flag = false;
            if(user_votes >= votes_to_win)
                flag = true;
            else
                for(int i=0;i<3;i++){
                    if( (arr1[i] - arr2[i]) >= votes_req){
                        flag = true;
                        break;
                    }
    ...
    /* docstring */
    static void ORANDCON() throws IOException {
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            int n = Integer.parseInt(sc.next());
            int a = n;
    ...
    /* docstring */
    static void ANTI_PAL() throws IOException {
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            int n = Integer.parseInt(sc.next());
            String str = sc.next();
