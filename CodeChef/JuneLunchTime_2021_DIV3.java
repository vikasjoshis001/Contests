...
class CodeChef {
    ...
    /* docstring*/
    static void CHFRICH() throws IOException{
    ...
    /* docstring*/
    static void FALSNUM() throws IOException{
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            // Write Your Code...
    ...
    /* docstring*/
    static void HTMLTAGS() throws IOException{
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            // Write Your Code...
            String str = sc.next();
    ...
    /* docstring*/
    static void UNONE() throws IOException{
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            // Write Your Code...
            int n = sc.nextInt();
    ...
    /* docstring*/
    static void REALBIN() throws IOException{
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            // Write Your Code...
            long A = sc.nextLong();
