...
class Main {
    ...
    /* docstring*/
    static void ShortestPathwithObstacle() throws IOException{
    ...
    /* docstring*/
    static void AlphabeticalStrings() throws IOException{
        int T = Integer.parseInt(sc.next());
        while (T-- > 0) {
            // Write Your Code...
        }
...
class Templates {
    ...
    static class FastScanner {
        ...
        long[] readLongArray(int n) {
            long[] a = new long[n];
            for (int i = 0; i < n; i++)Shortest Path with Obstacle
    ...
    static void updateRangeLazy(int tree[], int lazy[], int ss, int se, int l, int r, int increment, int index) {
        ...
        if (lazy[index] != 0) {Shortest Path with Obstacle
